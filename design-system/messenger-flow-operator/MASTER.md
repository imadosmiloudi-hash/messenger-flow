...
> **Production brand override:** locked dark neon (`#05070A` / `#0B1220` / primary `#22C55E` / Inter / glass) — teal tokens below are design-system defaults only.
...
**Project:** Messenger Flow Operator
**Generated:** 2026-09-13 22:05:58
